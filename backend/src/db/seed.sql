...
INSERT INTO node_templates (name, node_type, description, icon, color, default_input_params, default_validation, default_process_logic, default_output_template) VALUES
(
  'Create Order', 'Process', 'Membuat order baru dari data customer dan item', '📋', '#3b82f6',
...
(
  'Validate Product', 'Validation', 'Validasi produk dan ketersediaan stok', '✅', '#10b981',
...
(
  'Check Stock', 'Database', 'Cek dan reservasi stok di warehouse', '📦', '#8b5cf6',
...
(
  'Calculate Shipping', 'API', 'Hitung biaya pengiriman via courier API', '🚚', '#f59e0b',
...
(
  'Apply Promo', 'Logic', 'Terapkan rule promo berdasarkan member level', '🎫', '#06b6d4',
...
(
  'Generate Journal', 'Finance', 'Buat jurnal akuntansi untuk transaksi', '📊', '#ec4899',
...
(
  'Send to Courier', 'API', 'Kirim data order ke ekspedisi', '📨', '#f59e0b',
...
(
  'Verify Payment', 'Validation', 'Verifikasi status pembayaran dari payment gateway', '💳', '#10b981',
...
(
  'Send Notification', 'API', 'Kirim notifikasi email/WhatsApp ke customer', '📱', '#f59e0b',
...
(
  'Update Inventory', 'Database', 'Update data inventory setelah order dikonfirmasi', '🏭', '#8b5cf6',
...
(
  'Loop', 'Loop', 'Melakukan perulangan untuk setiap item dalam array', '🔁', '#f97316',
...
-- Sample Flow: Order Processing
INSERT INTO flows (name, description, version, status) VALUES
('Order Processing Flow', 'Alur lengkap pemrosesan order dari create hingga pengiriman', 'v1.2', 'active'),
('Payment Verification Flow', 'Proses verifikasi dan konfirmasi pembayaran multi metode', 'v1.1', 'active'),
('Inventory Management Flow', 'Manajemen stok dan update inventory real-time', 'v1.0', 'active'),
('Promo Engine Flow', 'Engine eksekusi dan validasi promo serta diskon', 'v1.3', 'active'),
('User Registration Flow', 'Pendaftaran dan verifikasi user baru', 'v1.0', 'draft');
